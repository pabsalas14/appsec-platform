...
**Referencia de implementación:** `frontend/src/app/(dashboard)/subdireccions/page.tsx` (búsqueda, tabla, crear/editar/eliminar).
...
Incluye (no exhaustivo): `gerencias`, `organizacions`, `celulas`, `repositorios`, `activo_webs`, `service_releases`, `iniciativas`, `hallazgo_*`, `programa_*`, `control_*`, etc.
