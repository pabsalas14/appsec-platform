...
**Interacción:** Las tarjetas de motor no son clicables. Son solo informativas. Si el usuario quiere filtrar por un motor específico, debe usar el botón de Filtros Globales.
...
**Interacción:** Al pasar el cursor sobre la gráfica, se muestra un tooltip con los valores exactos de las 4 series para ese mes. No hay acción al hacer clic en la gráfica.
