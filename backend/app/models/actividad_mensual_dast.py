"""ActividadMensualDast model — actividad mensual de DAST por activo web (BRD §5.2)."""
...
class ActividadMensualDast(SoftDeleteMixin, Base):
    __tablename__ = "actividad_mensual_dasts"
    ...
    programa_dast: Mapped[ProgramaDast] = relationship(back_populates="actividades")
