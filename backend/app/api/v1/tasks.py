...
async def list_tasks(
    ...
    project_id: uuid.UUID | None = Query(default=None, description="Filter tasks by parent project"),
):
...
async def update_task(
    ...
    updated = await task_svc.update(db, task.id, task_in, scope={"user_id": current_user.id})
