"""ActividadMensualDast schemas — Pydantic v2."""
...
class ActividadMensualDastBase(BaseModel):
...
class ActividadMensualDastCreate(ActividadMensualDastBase):
    pass


class ActividadMensualDastUpdate(BaseModel):
...
class ActividadMensualDastRead(ActividadMensualDastBase):
