"""Smoke + IDOR tests for the dashboard_config entity — generated."""
...
@pytest.mark.asyncio
async def test_create_dashboard_config(client: AsyncClient, auth_headers: dict):
...
@pytest.mark.asyncio
async def test_list_dashboard_configs_empty(client: AsyncClient, auth_headers: dict):
...
@pytest.mark.asyncio
async def test_dashboard_config_idor_protected(
    client: AsyncClient,
    auth_headers: dict,
