    ...
    <form className="space-y-4" onSubmit={onSubmit}>
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder='{"motor":"Semgrep","version":"1.x"}'
        />
...
export default function ProgramaSastsPage() {
  ...
  return (
    <PageWrapper className="space-y-6 p-6">
      <PageHeader
        title="Registros — Programas SAST"
        description="Programas de análisis estático vinculados a repositorio. El consolidado anual está en la otra pestaña."
      >
